...
public class EmailTest {
    private String from = "xxx@163.com"; // 发件人邮箱地址
    private String user = "xxx"; // 发件人称号，同邮箱地址
    private String password = "xxxx"; // 发件人邮箱客户端授权码
    ...
    public boolean sendMail(String to, String text, String title) {
        ...
        props.setProperty("mail.smtp.host", "xxxx@163.com"); // 设置发送邮件的邮件服务器的属性（这里使用网易的smtp服务器）
        props.put("mail.smtp.host", "xxxx@163.com"); // 需要经过授权，也就是有户名和密码的校验，这样才能通过验证（一定要有这一条）
    ...
    public static void main(String[] args) { // 做测试用
        EmailTest ds = new EmailTest();
        ds.sendMail("xxxx@126.com", "2018-8-20", "这次要成功");
